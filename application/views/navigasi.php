<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            <li class="dropdown">
              <a href="#" class="nav-link has-dropdown"><i class="fas fa-user text-danger"></i><span>Hi, <?php echo isset($level->nama)?$level->nama:'NULL'; ?></span></a>
            ...
            <li class="menu-header"><b><?= $level->level ?></b> Activity</li>
            <li>
            ...
            <?php if ($level->level == 'peminjam'): ?>
              <li><a href="<?php echo site_url('/'); ?>" class="nav-link"><i class="fas fa-user"></i><span>Barang Yang Dipinjam</span></a></li>
            <?php endif; ?>
          </ul>
